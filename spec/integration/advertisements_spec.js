...
describe("routes : advertisement", () => {
  ...
  describe("GET /advertisement", () => {
    it("should return a status code 200 and all avertisements", done => {
  ...
  describe("POST /advertisement/create", () => {
    const options = {
      ...
      form: {
        ...
        description: "buy this blink-182 album"
      }
    };
      ...
      request.post(options, (err, res, body) => {
        Advertisement.findOne({ where: { title: "blink-182 songs" } })
          .then(advertisement => {
            ...
            expect(topic.description).toBe("buy this blink-182 album");
            done();
          })
          .catch(err => {
            console.log(err);
    ...
    it("should update the advertisement with the given values", done => {
      ...
      request.post(options, (err, res, body) => {
        ...
        Advertisement.findOne({
          ...
          expect(advertisement.title).toBe("New Ad Title");
          done();
        });
      });
    });
